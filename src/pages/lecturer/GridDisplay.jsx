...
const GridDisplay = ({ showSidebar }) => {
  ...
  const folders = [
    { id: 1, name: 'Backup 2025', icon: '📁', size: 5200, items: 162 },
    { id: 2, name: 'Lập trình hướng đối tượng', icon: '📁', size: 2048, items: 98 },
    { id: 3, name: 'Cơ bản C++', icon: '📁', size: 1024, items: 215 },
    { id: 4, name: 'ReactJS với Vite', icon: '📁', size: 1000, items: 2 },
  ];
  ...
  return (
    <Layout>
      <div className="flex grid-cols-12 bg-gray-100">
        <div className={`grid grid-cols-11 gap-4 col-span-${showSidebar ? '11' : '12'}`}>
