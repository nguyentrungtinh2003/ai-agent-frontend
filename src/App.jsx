      ...
      <div className='flex gap-2 text-black'>
        <content className="w-full">
          ...
          <div className='flex flex-col gap-8'>
            ...
            <div className='h-32 w-32 bg-stone-500 justify-center flex text-6xl font-bold text-white items-center'>3</div>
          </div>
          <div className='flex flex-col gap-8'>
            <div className='flex items-center flex-col justify-end h-full'>
              <div className='h-32 w-32 bg-gray-300 rounded-[50%]'/>
            ...
            <div className='h-80 w-32 bg-teal-500 justify-center flex text-6xl font-bold text-white items-center'>1</div>
          </div>
          <div className='flex flex-col gap-8'>
            <div className='flex items-center flex-col justify-end h-full'>
              <div className='h-32 w-32 bg-gray-300 rounded-[50%]'/>
            ...
            <div className='h-46 w-32 bg-rose-500 justify-center flex text-6xl font-bold text-white items-center'>2</div>
          </div>
          </div>
